...
namespace EduCollab.Api.Controllers
{
    ...
    public class ScenesController : ControllerBase
    {
        ...
        public async Task<IActionResult> CreateScene([FromBody] CreateSceneRequest request, CancellationToken cancellationToken)
        {
            ...
            var created = await _sceneService.CreateSceneAsync(scene, cancellationToken);
            if (!created)
            {
            ...
            response.CanEdit = await _sceneService.CanCurrentUserManageSceneAsync(scene.OwnerUserId, cancellationToken);
            response.CanManage = response.CanEdit;
        ...
        public async Task<ActionResult<SceneResponse>> UpdateScene(int sceneId, [FromBody] UpdateSceneRequest request, CancellationToken cancellationToken)
        {
            ...
            response.CanEdit = await _sceneService.CanCurrentUserManageSceneAsync(updated.OwnerUserId, cancellationToken);
            response.CanManage = response.CanEdit;
