...
namespace EduCollab.Application.Services.Workspaces
{
    public interface IWorkspaceService
    {
        ...
        Task InviteUserToWorkspaceAsync(int workspaceId, string email, IReadOnlySet<string> parameters, int groupId, CancellationToken cancellationToken);
        Task InviteUserToCurrentWorkspaceAsync(string email, IReadOnlySet<string> parameters, int groupId, CancellationToken cancellationToken);
        ...
        Task<List<WorkspaceMember>> GetCurrentUserWorkspaceMembershipsAsync(CancellationToken cancellationToken);
        Task<List<Workspace>> GetCurrentUserWorkspacesAsync(CancellationToken cancellationToken);
        Task<bool> SetActiveWorkspaceAsync(int workspaceId, CancellationToken cancellationToken);
    }
}
