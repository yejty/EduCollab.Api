    ...
    protected override void ConfigureWebHost(IWebHostBuilder builder)
    {
        ...
        builder.ConfigureAppConfiguration((_, config) =>
        {
            config.AddInMemoryCollection(new Dictionary<string, string?>
            {
                ...
                ["SessionJoin:SecretKey"] = "integration-tests-session-join-secret-key-32",
                ["SessionJoin:Issuer"] = "EduCollab.Api.Tests",
                ["SessionJoin:Audience"] = "EduCollab.CollabServer.Tests",
                ["SessionJoin:ExpirationMinutes"] = "10",
                ["SessionJoin:ColyseusEndpoint"] = "ws://localhost:2567",
                ["SessionJoin:FrontendGuestJoinUrl"] = "http://localhost/sessions/join",
                ["SessionJoin:GuestLinkExpirationHours"] = "168",
                ["SessionJoin:AbandonedSessionIdleHours"] = "24",
                ["InternalApi:ApiKey"] = "integration-tests-internal-api-key",
